...
// Abfrage ausführen
try {
    $stmt = $pdo->prepare("select Mitarbeiter.name, Mitarbeiter.focus, Mitarbeiter.sex, Abteilung.name from Mitarbeiter JOIN Abteilung ON Mitarbeiter.abteilungId = Abteilung.id where online = 1");
    $stmt->execute();
