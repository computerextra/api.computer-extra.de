...
function Section_2(): string
{
    $body = <<<HTML
    <bookmark content="§ 2 Anwendungsbereich und Verantwortlichkeit" />
...
function Section_3(): string
{
    $body = <<<HTML
    <bookmark content="§ 3 Gegenstand und Dauer des Auftrages" />
...
function Section_4(): string
{
    $body = <<<HTML
    <bookmark content="§ 4 Beschreibung der Verarbeitung, Daten und betroffener Personen" />
...
function Section_5(): string
{
    $body = <<<HTML
    <bookmark content="§ 5 Technische und organisatorische Maßnahmen" />
...
function Section_6(): string
{
    $body = <<<HTML
    <bookmark content="§ 6 Berichtigung, Einschränkung und Löschung von Daten" />
...
function Section_7(): string
{
    $body = <<<HTML
    <bookmark content="§ 7 Pflichten des Auftragnehmers" />
...
function Section_8(): string
{
    $body = <<<HTML
    <bookmark content="§ 8 Rechte und Pflichten des Auftraggebers" />
...
function Section_9(): string
{
    $body = <<<HTML
    <bookmark content="§ 9 Wahrung von Rechten der betroffenen Person" />
...
function Section_10(): string
{
    $body = <<<HTML
    <bookmark content="§ 10 Kontrollbefugnisse" />
...
function Section_11(): string
{
    $body = <<<HTML
    <bookmark content="§ 11 Unterauftragsverhältnisse" />
...
function Section_12(): string
{
    $body = <<<HTML
    <bookmark content="§ 12 Datengeheimnis und Geheimhaltungspflichten" />
...
function Section_13(): string
{
    $body = <<<HTML
    <bookmark content="§ 13 Informationspflichten, Schriftformklausel, Rechtswahl" />
